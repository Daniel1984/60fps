...
(function() {
  ...
  function Ground() {
    ...
    var texture = PIXI.Texture.fromFrame(FP.LANDSCAPE_PATH + 'ground' + randomGround + '.png');
...
(function() {
  ...
  Main.prototype.setupInteractivity = function() {
    this.setInteractive(true);
    this.hitArea = new PIXI.Rectangle(0, 0, FP.getWidth(),FP.getHeight());
...
(function() {
  ...
  Plane.prototype.triggerGameOver = function() {
    FP.GAME_OVER = true;
    this.parent.parent.showGameOver();
  };
...
(function() {
  ...
  Main.prototype.addPuffs = function() {
    ...
    puff.position.x = this.plane.position.x - this.plane.width;
...
(function() {
  ...
  Rock.prototype.setupPositioning = function(posX, yPlacement, height_delta) {
    this.height = Math.floor(FP.getHeight() / 2 - height_delta);
...
(function() {
  ...
  Main.prototype.addRocks = function() {
    ...
    var textureUp = PIXI.Texture.fromFrame(FP.LANDSCAPE_PATH + 'rock' + randomRock + '.png');
    var textureDown = PIXI.Texture.fromFrame(FP.LANDSCAPE_PATH + 'rock' + randomRock + 'Down.png');
